...
import           Xenon.Transform.InitialEquals (computeAllInitialEqualVars)
import           Xenon.Analyze.ModuleSummary
import           Xenon.Language.Annotation
import           Xenon.Language.IR hiding (isStar)
import           Xenon.Transform.Horn
import           Xenon.Transform.Normalize (NormalizeOutput2, TRSubs2, UpdateIndices(..))
import           Xenon.Transform.TransitionRelation
import           Xenon.Types
import           Xenon.Utils
    ...
    let inputs  = moduleInputs targetModule targetModuleClocks
        ...
        mkInputSubs i = do
          ...
          let -- input port of the target module
              ...
              invArgVarName = "XenonTmpMIInput_" <> T.pack (show $ getData mi) <> "_" <> i
